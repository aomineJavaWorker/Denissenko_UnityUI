...
public class dragScript : MonoBehaviour, IPointerDownHandler, IDragHandler, IEndDragHandler, IBeginDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        {
            objectScript.clothingManager.EquipClothing(objectScript.clothingCategory, objectScript.clothingPrefab);
        }
